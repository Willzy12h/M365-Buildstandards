...
- **Six pages hid content at small sizes.** Assessment, Configuration, Deviations, Manual checks, Plan and Build Standard give their tables whatever height is left under the heading, with no page scroll. At 1180x640 the Plan and Build Standard guidance was cut off with nothing to scroll to. These pages now fill the window down to `PageLayout.MinimumHeight` (560, below the 593px they get at 1180x760) and scroll below it; at 1180x760 and the default size nothing changes, and the harness fails if they scroll there.
...
- **The 600px page minimum was above the 593px these pages get at 1180x760**, so it added scrolling and reflow at a size that had worked. It is now 560, and the harness fails if a filling page scrolls at 1180x760 or larger. This record had claimed 1180x760 was unchanged without measuring it.
